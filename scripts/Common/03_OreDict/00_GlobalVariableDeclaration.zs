...
/***** Augmented Lumps *****/
global hashLumpAugmented as IOreDictEntry[string] = {} as IOreDictEntry[string];
val stringLumpAugmented = [
...
for lumpAugmented in stringLumpAugmented {
	hashLumpAugmented[lumpAugmented] = oreDict["augmentedLump" ~ lumpAugmented];
}

/***** Tesla Lumps *****/
global hashLumpTesla as IOreDictEntry[string] = {} as IOreDictEntry[string];
val stringLumpTesla = [
...
for lumpTesla in stringLumpTesla {
	hashLumpTesla[lumpTesla] = oreDict["teslaLump" ~ lumpTesla];
}
