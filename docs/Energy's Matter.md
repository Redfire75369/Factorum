...
**Note: All Heat Sources and Coolants Supported are listed below**

- Inputs and Outputs
	- Energy
		- Output: 0.1 T/tK
	- Time
		- Temperature Increase: 1 t/K
...
the input items. The Molecular Transmutator can materialise items that have already been scanned,but cannot formulate any original items. 
The Molecular Transmutator can only materialise raw and basic materials, not complex items or machinery. <br/>
...
- Inputs and Outputs
	- Item
		- Input: Empty Molecular Schema, Item to be replicated
		- Output: Mapped Molecular Structure
	- Energy
		- Input:
	- Time
		- 7200 ticks
